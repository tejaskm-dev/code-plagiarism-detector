 ...
 * of a 540-file corpus, and is written up in {@code ai-detection-results.md}. What they
...
class AiAuthorshipModelTest {
    ...
    void theBandMatchesThePublishedNumber() {
        // ai-detection-results.md reports 96.6% accuracy on decided files at +/-0.10.
